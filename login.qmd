...
<button type="submit" id="signup-redirect" style="width: 100%; padding-top: 10px; background-color: #007BFF; color: white; border: none; border-radius: 5px; cursor: pointer;">
...
<script>
  ...
  document.getElementById("signup-redirect").addEventListener("click", function() {
    window.location.href = "inscription.html";  // Remplace si besoin
  });
</script>
```
